    ...
    >
      <div className="flex justify-between mb-4">
        <div>
          ...
          <p className="text-lg font-bold">$5,756</p>
        </div>
        <div>
          <svg
            version="1.1"
      ...
      <div className="flex justify-between mb-1">
        ...
        <p className="text-sm font-semibold">Valid Thru</p>
      </div>
      <div className="flex justify-between">
        <p className="text-base font-bold">Eddy Cusuma</p>
        <p className="text-base font-bold">12/22</p>
      </div>
      <div className="flex justify-between mt-4">
        <p className="text-base font-bold">3778 ****** **** 1234</p>
